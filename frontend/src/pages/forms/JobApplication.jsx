            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="flex justify-end pt-4">
                            <button
                                type="button"
                                onClick={handleNext}
                                disabled={!formData.fullName || !formData.email || !formData.mobile || !formData.location}
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            ...
                            {formData.experienceLevel === 'Experienced' && (
                                <div className="space-y-2">
                                    <label className="text-gray-400 text-xs md:text-sm">Years of Experience <span className="text-red-500">*</span></label>
                                    <input required type="text" name="yearsOfExperience" value={formData.yearsOfExperience} onChange={handleChange} className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors" placeholder="e.g. 2 Years" />
                                </div>
                            )}
                        </div>
                ...
                {step === 3 && (
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <label className="text-gray-400 text-xs md:text-sm">Portfolio / LinkedIn URL <span className="text-red-500">*</span></label>
                            <input required type="url" name="portfolio" value={formData.portfolio} onChange={handleChange} className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors" placeholder="https://" />
                        </div>
                        ...
                        <div className="flex justify-between pt-8 border-t border-white/10">
                            ...
                            <button
                                type="submit"
                                disabled={isSubmitting || !resumeFile || !formData.portfolio || !formData.whyJoin}
