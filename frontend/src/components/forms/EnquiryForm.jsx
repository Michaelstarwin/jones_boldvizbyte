    ...
    return (
        <div className="bg-dark-bg/50 border border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={status === 'submitting' || !formData.name || !formData.email || !formData.mobile || !formData.type || !formData.message}
                    className="w-full bg-white text-black font-orbitron font-bold py-3 rounded-lg hover:bg-gray-200 transition-all flex items-center justify-center gap-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-target"
                >
