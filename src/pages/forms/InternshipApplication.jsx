...
const InternshipApplication = ({ isModal = false, onClose = () => { }, initialData = {} }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await submitLead({
            ...
            message: `College: ${formData.college} | Degree: ${formData.degree} | Why: ${formData.whyJoin} | Goals: ${formData.learningGoal} | Duration: ${formData.duration} | Mode: ${formData.mode}`,
            file: resumeFile
        });
            ...
            <AnimatePresence mode="wait">
                {step === 1 && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-gray-400 text-xs md:text-sm">Degree & Year</label>
                                <input type="text" name="degree" value={formData.degree} onChange={handleChange} className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors" placeholder="B.Tech 3rd Year" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <label className="text-gray-400 text-xs md:text-sm">College / Institution Name</label>
                            <input type="text" name="college" value={formData.college} onChange={handleChange} className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors" placeholder="Institute Name" />
                        </div>
                ...
                {step === 2 && (
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <label className="text-gray-400 text-xs md:text-sm">Why do you want this internship?</label>
                            <textarea name="whyJoin" value={formData.whyJoin} onChange={handleChange} rows="2" className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors resize-none" placeholder="Your motivation..." />
                        </div>

                        <div className="space-y-2">
                            <label className="text-gray-400 text-xs md:text-sm">What skills do you want to learn?</label>
                            <textarea name="learningGoal" value={formData.learningGoal} onChange={handleChange} rows="2" className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors resize-none" placeholder="React, Marketing, Sales, etc." />
                        </div>
                ...
                {step === 3 && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            <div className="space-y-2">
                                <label className="text-gray-400 text-xs md:text-sm">Duration</label>
                                <select name="duration" value={formData.duration} onChange={handleChange} className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors appearance-none cursor-pointer">
                            ...
                            <div className="space-y-2">
                                <label className="text-gray-400 text-xs md:text-sm">Mode</label>
                                <select name="mode" value={formData.mode} onChange={handleChange} className="w-full bg-dark-bg/50 border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-blue transition-colors appearance-none cursor-pointer">
